			...
			<div>
				<nav className="NavbarItems">
					<h1 className="navbar-logo">
						Designr <i className="fab fa-dyalog" />
					</h1>
					...
					<GoogleLogout clientId={clientId} buttonText="Sign Out" onLogoutSuccess={this.onSignoutSuccess} />
					{/* <Button clientId={clientId} onClick={this.onsignoutSuccess}>signout</Button> */}
				</nav>
				{this.state.showMydesigns ? <MyDesigns /> : <CompanyList />}
			</div>
		);
	}
}
